...
console.log(`Device info: Mobile=${isMobile}, Width=${window.innerWidth}, UserAgent=${navigator.userAgent.substring(0, 50)}...`);
...
if (isMobile) {
  ...
  // Десктоп - быстрее
  console.log('Desktop device detected - using 1 second delay');
  setTimeout(() => {
    rootElement.style.opacity = '1';
    rootElement.style.visibility = 'visible';
    document.body.style.overflow = 'auto';
